...
<img class="main-img" src="/images/kormoran-i2.jpg" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<div class="static-text" use:scrollReveal={{ variant: 'fade', delay: 100 }}>
	...
	<p><img src="/images/ki.png" alt={translations.ports.port1Title} /></p>
</div>

<img class="main-img" src="/images/kormoran-ii2.jpg" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<img class="main-img" src="/images/kormoran-iii1.jpg" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<div class="static-text" use:scrollReveal={{ variant: 'fade', delay: 100 }}>
	...
	<p><img src="/images/kiii.png" alt={translations.ports.port3Title} /></p>
</div>

<img class="main-img" src="/images/kormoran-iv.jpg" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<div class="static-text" use:scrollReveal={{ variant: 'fade', delay: 100 }}>
	...
	<p><img src="/images/kiv.png" alt={translations.ports.port4Title} /></p>
</div>

<img class="main-img" src="/images/kormoran-v1.jpg" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<div class="static-text" use:scrollReveal={{ variant: 'fade', delay: 100 }}>
	...
	<p><img src="/images/kv.png" alt={translations.ports.port5Title} /></p>
</div>

<img class="main-img" src="/images/sturovo-pristav.png" alt="" use:scrollReveal={{ variant: 'fade' }} />
...
<div class="static-text" use:scrollReveal={{ variant: 'fade', delay: 100 }}>
	...
	<p><img src="/images/kvi.png" alt={translations.ports.port6Title} /></p>
</div>
